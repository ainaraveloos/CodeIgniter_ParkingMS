      ...
      <div class="col-12 col-md-6 col-xl-7">
        <div class="d-flex justify-content-center text-bg-primary">
          <div class="col-12 col-xl-9">
            ...
            <h2 class="h1 mb-4">Sign In ParkIn</h2>
            <p class="lead mb-5">You can sign here in to redirect to the admin dashboard</p>
            <div class="text-endx">
          ...
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="row">
              <div class="col-12">
                ...
                <?php endif;?>
                  <p>Add User <a class="text-success" href="<?= base_url('/register')?>">Here</a></p>
                </div>
              </div>
            </div>
